...
function simulate_panel_extra_shock(grid::grids, sim::sim_param, model::model_params, tm::transition_matrices, χ̂::Array{Int64,2}, policy::Array{Float64,4}, shock::shocks, fshocks::Array{Float64,2})
