...
function hazard(grid::grids, sim::sim_param, model::model_params, tm::transition_matrices, χ̂::Array{Int64,2}, policy::Array{Float64,3}, policyadjust::Array{Float64,2}, shock::shocks)
    ...
    for k=1:numsim+burnin # for each period
        ...
        for i=1:numfirms
            ...
            pricetodaywitoutmenu[i] = policyadjust[Int(currentfirmstate[i,2]),Int(currentfirmstate[i,3])]
            # Calculate Hazard
            if k>burnin
